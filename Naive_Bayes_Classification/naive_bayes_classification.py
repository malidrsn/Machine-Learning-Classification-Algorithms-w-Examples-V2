# koşullu olasılığı dayanan bir yöntemdir.
# dengesiz veri kümelerinde çalışabilmektedir.
# olasılıksal dağılımına bakarak sınıflandırma yapıyor tüm dağılıma bakıyor
# gaussian nb - multinominal nb- bernoulli nb gibi farklı dağılımlarda çalışılabilmekte
# gaussian nb = contunious sürekli reel sayısal bir değerse kullanılır
# multinominal = ünilere değerler atanıp 1-2-3-4 ... gibi ve kullanılacaksa seçilir
# bernoulli = 0-1 gibi dağılımlarda kullanılır
