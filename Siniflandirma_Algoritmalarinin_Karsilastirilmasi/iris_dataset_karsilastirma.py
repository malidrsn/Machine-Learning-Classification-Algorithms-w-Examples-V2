...
con_matrix_rf = confusion_matrix(y_test, y_pred_dtc)
print("confusion matrix_rf\n", con_matrix_rf)
print("score Random Forest Classifier", rf_cls.score(X_test, y_test))

# roc tpr,fpr değerleri

y_pred_rf_probability = rf_cls.predict_proba(X_test)
print("Probability", y_pred_rf_probability)  # [k,e] verir

from sklearn import metrics

fpr, tpr, thold = metrics.roc_curve(y_test, y_pred_rf_probability[:, 0], pos_label="e")
print("frp", fpr)
print("tpr", tpr)
print("THOLD", thold)
